...
var
  ...
  AppWrapper = function (_React$Component) {
    _inherits(AppWrapper, _React$Component);

    function AppWrapper(props) {
      _classCallCheck(this, AppWrapper);
      var _this = _possibleConstructorReturn(this, (AppWrapper.__proto__ || Object.getPrototypeOf(AppWrapper)).call(this,
        props));
      _this.state = {
        currentData: '',
        color: ''
        ...
        return (
          React.createElement('div', {
            ...
            React.createElement('div', {
              ...
              React.createElement(QuoteText, {
                text: this.state.currentData.quote,
                color: this.state.color
              }),
              React.createElement(QuoteAuthor, {
                author: this.state.currentData.author,
                color: this.state.color
              }),
...
var
  ...
  QuoteText = function (_React$Component2) {
    _inherits(QuoteText, _React$Component2);

    function QuoteText(props) {
      _classCallCheck(this, QuoteText);
      var _this2 = _possibleConstructorReturn(this, (QuoteText.__proto__ || Object.getPrototypeOf(QuoteText)).call(this,
        props));
      _this2.state = {};
      return _this2;
    }
...
var
  ...
  QuoteAuthor = function (_React$Component3) {
    _inherits(QuoteAuthor, _React$Component3);

    function QuoteAuthor(props) {
      _classCallCheck(this, QuoteAuthor);
      var _this3 = _possibleConstructorReturn(this, (QuoteAuthor.__proto__ || Object.getPrototypeOf(QuoteAuthor)).call(this,
        props));
      _this3.state = {};
      return _this3;
    }
...
var
  ...
  Buttons = function (_React$Component4) {
    _inherits(Buttons, _React$Component4);

    function Buttons(props) {
      _classCallCheck(this, Buttons);
      var _this4 = _possibleConstructorReturn(this, (Buttons.__proto__ || Object.getPrototypeOf(Buttons)).call(this,
        props));
      _this4.state = {};
      return _this4;
    }
...
var
  ...
  Footer = function (_React$Component5) {
    _inherits(Footer, _React$Component5);

    function Footer(props) {
      _classCallCheck(this, Footer);
      var _this5 = _possibleConstructorReturn(this, (Footer.__proto__ || Object.getPrototypeOf(Footer)).call(this,
        props));
      _this5.state = {};
      return _this5;
    }
